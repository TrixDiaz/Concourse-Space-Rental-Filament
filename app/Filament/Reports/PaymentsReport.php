    ...
    public function paymentsSummary(?array $filters): Collection
    {
        ...
        return collect([
            ...
            return [
                ...
                'column3' => number_format($payment->water_consumption ?? 0, 2),
                'column4' => number_format($payment->water_bill ?? 0, 2),
                'column5' => number_format($payment->electricity_consumption ?? 0, 2),
                'column6' => number_format($payment->electricity_bill ?? 0, 2),
                'column7' => number_format($payment->water_due ?? 0, 2),
                'column8' => number_format($payment->electricity_due ?? 0, 2),
            ];
        }));
    }
